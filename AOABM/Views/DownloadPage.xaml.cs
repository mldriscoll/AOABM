            ...
            },
            {
                "ascendance-of-a-bookworm-manga-part-2-vol-1", new VolumeDefinition
                {
                    ...
                    mapping = new List<VolumeDefinition.Mapping>
                    {
                        new VolumeDefinition.Mapping
                        {
                            Folder = "102-I'll even join the temple to read books!\\100-Covers",
                            Files = new List<Inp>
                            {
                                new Inp(0){NameOne = "cover.jpg"}
                            },
                        ...
                        new VolumeDefinition.Mapping
                        {
                            Folder = "102-I'll even join the temple to read books!\\101-Apprentice Shrine Maiden in the Temple",
